...
<div class="col-md-12">
	<div class="card">
	  ...
	  <div class="card-body">
	    <div class="row">
	      <div class="col-md-4 px-1">
	        <div class="form-group">
	          <label>Nombre</label>
	          <input type="text" id="nombre_alumno" class="form-control" placeholder="Nombre" value="<?php echo  htmlspecialchars($nombre,  ENT_QUOTES, 'UTF-8'); ?>">
	        </div>
	      </div>
	    ...
	    <div class="row">
	      ...
	      <div class="col-md-4">
	        ...
	        <input id="fec_nac" type="date" id="fec_nac" class="form-control" placeholder="Fecha de nacimiento" value="<?php echo  htmlspecialchars($fecha_naciemiento,  ENT_QUOTES, 'UTF-8'); ?>">
	      </div>
	      <div class="col-md-4">
	      ...
	      <div class="col-md-6 pr-1">
	        <div class="form-group">
	          ...
	          <input type="number" id="matricula" class="form-control" placeholder="Matricula" value="<?php echo
	           htmlspecialchars($matricula,  ENT_QUOTES, 'UTF-8');  ?>">
	        </div>
	      </div>
	    ...
	    <div class="row">
	      <div class="col-md-6">
	        <div class="form-group">
	          ...
	          <input type="number" id="tel_celular" class="form-control" placeholder="Telefono Celular" value="<?php echo  htmlspecialchars($telefono_celular,  ENT_QUOTES, 'UTF-8'); ?>">
	        </div>
	      </div>
	      <div class="col-md-6">
	        <div class="form-group">
	  ...
	  <div class="card-footer">
	    <a href="#!" class="btn btn-primary btn-block" id="btn_modificar_alumno" data-id="<?php echo  htmlspecialchars($id_alumno,  ENT_QUOTES, 'UTF-8'); ?>">Modificar Alumno</a>
	  </div>
	</div>
</div>
