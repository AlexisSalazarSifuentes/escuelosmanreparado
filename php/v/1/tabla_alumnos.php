...
$row_alumnos = $sql->obtenerResultado("CALL sp_select_alumnos()");
...
<div class="col-md-12">
  <div class="card card-plain">
    <div class="card-header">
      ...
      <div class="row">
        <div class="col-md-9">
          <input class="form-control" type="search" name="busqueda_alumno" id="busqueda_alumno" placeholder="Busqueda por apellido paterno">
        </div>
        <div class="col-md-3"><a href="#!" id="btn_buscar_alumno" class="btn btn-secundary">Buscar</a></div>
      </div>
      <p class="category">Se muestran todos los alumnos</p>
    </div>
    <div class="card-body">
