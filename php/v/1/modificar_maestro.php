	  ...
	  <div class="card-body">
	    <div class="row">
	      <div class="col-md-4 px-1">
	        <div class="form-group">
	          <label>Nombre</label>
	          <input type="text" id="nombre_maestro" class="form-control" placeholder="Nombre" value="<?php echo $maestro; ?>">
	        </div>
	      </div>
	    ...
	    <div class="row">
	      ...
	      <div class="col-md-4">
	        ...
	        <input id="fec_nac" type="date" id="fec_nac" class="form-control" placeholder="Fecha de nacimiento" value="<?php echo $fecha_nac; ?>">
	      </div>
	    </div>
	    <div class="row">
	      <div class="col-md-6 pr-1">
	        <div class="form-group">
	          ...
	          <input type="number" id="matricula" class="form-control" placeholder="Matricula" value="<?php echo $matricula; ?>">
	        </div>
	      </div>
	    ...
	    <div class="row">
	      <div class="col-md-6">
	        <div class="form-group">
	          ...
	          <input type="number" id="tel_celular" class="form-control" placeholder="Telefono Celular" value="<?php echo $telefono_cel; ?>">
	        </div>
	      </div>
	      <div class="col-md-6">
	        <div class="form-group">
	    ...
	    <div class="row">
			<div class="col-md-12">
				<div class="form-group">
					...
					<input type="text" id="grado_academico" class="form-control" placeholder="Licenciatura, Ingenieria..." value="<?php echo $grado_academico; ?>">
				</div>
			</div>
	    </div>
	  </div>
	  <div class="card-footer">
	    <a href="#!" class="btn btn-primary btn-block" id="modificar_maestro" data-id="<?php echo $id_maestro; ?>">Modificar maestro</a>
	  </div>
	</div>
</div>